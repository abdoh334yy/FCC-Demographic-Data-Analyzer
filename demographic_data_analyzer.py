...
def calculate_demographic_data(print_data=True):
    ...
    non_percentage_higher = len(higher_education[higher_education["salary"] == ">50K"]) / len(higher_education) * 100
    higher_education_rich = round(non_percentage_higher / len(higher_education) * 100, 1)
    non_percentage_lower = len(lower_education[lower_education["salary"] == ">50K"]) / len(lower_education) * 100
    ...
    people_in_india = df[[df["native-country"] == "India" and df["salary"] == ">50K"]]
    occupation_count = people_in_india['occupation'].value_counts()
